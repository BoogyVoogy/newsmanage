...
<form:form method="post" action="../changearticle" commandName="news">
    ...
    <table>
        <tr>
            ...
            <td><form:input path="id" value="${news.id}" readonly="true"/></td>
        </tr>
        <tr>
            <td><form:label path="title">
                <spring:message code="label.newsname" />
            </form:label></td>
            <td><form:input path="title" value="${news.title}" /></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2"><input type="submit"
                                   value="<spring:message code="label.changearticle"/>" /></td>
        </tr>
